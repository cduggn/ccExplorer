...
func ConvertToStdoutType(s []Service,
	granularity string) CostAndUsageStdoutType {

	outputType := CostAndUsageStdoutType{
...
func ConvertToForecastStdoutType(r ForecastPrintData,
	filteredBy string) ForecastStdoutType {
	var forecast []ForecastResults
	for _, v := range r.Forecast.ForecastResultsByTime {
		forecast = append(forecast, ForecastResults{
